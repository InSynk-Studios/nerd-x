/**
 * This file is to seed the exchange.
 * Basically, fill up some data in the exchange so that the exchange has some data to show.
 */
...
module.exports = async function (callback) {
  try {
    ...
    // User 1 makes 10 orders to get tokens
    for (let i = 1; i <= 10; i++) {
    ...
    // User 2 makes 10 orders to get tokens
    for (let i = 1; i <= 10; i++) {
